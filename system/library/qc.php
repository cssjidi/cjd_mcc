...
class QC extends QqAuth{
     ...
     * @return Object QC
     */
    public function __construct($appid,$appkey,$appcallback,$access_token = "", $openid = "",$apperrreport=false,$appscope=null){
        parent::__construct($appid,$appkey,$appcallback,$apperrreport=false,$appscope=null);
