      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-account" class="form-horizontal">
          <div class="form-group" style="display: none;">
            ...
            <div class="col-sm-10">
              <select name="allcate_theme" id="input-theme" class="form-control">
                <?php foreach($allcate_themes as $index=>$theme){ ?>
                  <?php if ($index == $allcate_theme) { ?>
                    <option value="<?php echo $index; ?>" selected="selected"><?php echo $theme; ?></option>
                  <?php } else { ?>
                    <option value="<?php echo $index; ?>"><?php echo $theme; ?></option>
                  <?php } ?>
                <?php } ?>
              </select>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="allcate_status" id="input-status" class="form-control">
                <?php if ($allcate_status) { ?>
