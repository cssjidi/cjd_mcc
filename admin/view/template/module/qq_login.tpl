    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-name"><?php echo $text_appid; ?></label>
            <div class="col-sm-10">
              <input type="text" name="qq_login_appid" value="<?php echo $qq_login_appid; ?>" placeholder="<?php echo $qq_login_appid; ?>" id="input-name" class="form-control" />
              <?php if ($error_appid) { ?>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-name"><?php echo $text_appkey; ?></label>
            <div class="col-sm-10">
              <input type="text" name="qq_login_appkey" value="<?php echo $qq_login_appkey; ?>" placeholder="<?php echo $qq_login_appkey; ?>" id="input-name" class="form-control" />
              <?php if ($error_appkey) { ?>
