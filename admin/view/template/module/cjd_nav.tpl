                        ...
                        <div class="panel-heading">
                            <div class="panel-title">
                                <div class="row" style="line-height:35px;height:35px;">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="cjd_nav_status" id="input-status" class="form-control">
                                            <?php if ($cjd_nav_status) { ?>
                                        ...
                                        <textarea name="cjd_nav_setting" id="setting" style="display: none;">
...
<script>
    $(document).ready(function(){
        cjdMenu.options.items = <?php echo trim($cjd_nav_setting);?>;
        cjdMenu.init();
    });
</script>