...
$_['text_success']        = 'Success: "'.$_['module_name'] .'" settings cnanged!';
...
//$_['entry_img_select']          = 'Select Options Picture';
//$_['entry_img_select_help']     = 'adds the word "Select" option below each image in the list of goods, when clicking on the label corresponding option is selected automatically';
...
//$_['entry_img_sort']            = 'Through sorting images';
//$_['entry_img_sort_help']       = 'sorting images according to said order, regardless of the options to which they are attached';
